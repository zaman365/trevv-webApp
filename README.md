...
The database integration runner executes files sequentially against the shared PostgreSQL server and gives each test a 30-second default budget for database creation, migrations, fixtures, and cleanup. Explicit transaction-concurrency cases, 10,000-row fixtures, and query-budget assertions remain part of the suite; larger scenarios retain their explicit test budgets.
