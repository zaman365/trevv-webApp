...
export function UniversalCreateDialog({
  ...
  const selectedType = captureTypes[type];
    ...
    >
      ...
      >
        <header className="universal-create-header">
          ...
          <div>
            <h2 id="universal-create-title">Quick capture</h2>
        ...
        <div className="create-dialog-scroll">
          <QuickCaptureTypes
            ...
            onChange={(nextType) => {
              setType(nextType);
              if (nextType === "approval" || nextType === "milestone") {
                setDueDate((current) => current || "2026-09-10");
              }
            }}
          >
