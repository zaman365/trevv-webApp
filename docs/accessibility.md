...
CI runs axe against sign-in, Portfolio, Workspace Overview, Board, item panel, and Decision Center at desktop and mobile breakpoints. Serious and critical WCAG A/AA violations fail the build. Playwright also exercises the item panel and key navigation paths.
