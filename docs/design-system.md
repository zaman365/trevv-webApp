...
FounderHQ uses a calm, premium, data-dense visual language distinct from monday.com. Light mode is primary; dark mode shares semantic tokens.
...
- 10–12 px controls, 14–18 px cards, border-first elevation
