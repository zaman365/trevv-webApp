...
| Workspace Lead | Assigned Workspace management, Workspace team, updates, boards, statuses, and copied templates             |
| Member         | Create/edit/comment in assigned Workspaces subject to board permissions                                    |
| Guest          | Explicitly shared resources only; no directory, unrelated Workspace names, global metrics, or broad search |
