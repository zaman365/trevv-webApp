...
2. Product slice: polished Portfolio, Workspace, Board, and item-detail surfaces with realistic shared seed records.
...
4. Native foundations: Expo and Tauri shells that use the same contracts/client and support hosted session restoration, Portfolio, Workspaces, and deep-link/notification abstractions.
